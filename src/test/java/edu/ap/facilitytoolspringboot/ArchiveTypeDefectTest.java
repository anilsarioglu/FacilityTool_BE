...
public class ArchiveTypeDefectTest {
    @Test
    public void getReportsForArchiveShouldReturnReportsWithTypeDefectAndStatusBeeindigdOrGeannuleerdOrWNU() {
        // Arrange
        final String TYPE = "Defect";
        ...
        Report report3 = new Report("Mamm Samm", "P124266", new Date(), " Defect ", new Date(), "00.08 ONTSPANNINGSRUIMTE",
                "Lift", "Gaat niet naar boven","", EnumStatus.IN_BEHANDELING, new Object());
        ...
        expectedReportsList.add(report4);
